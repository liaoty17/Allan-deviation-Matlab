...
tauin = m';
DeviationType = "OADEV"; % Overlapping allan deviation
...
[out_tau, dev_out, out_err, alpha] = AllanTools_Matlab(DeviationType, datain, tau0, data_type, tauin); % Use default values for the remaining parameters.
...
ylabel(strcat("Deviation ",{32}, DeviationType, {32} ,"$\sigma_{y}(\tau)$"),"Interpreter","latex","FontSize",14,"FontWeight","normal","FontName","Times New Roman")
